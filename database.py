...
SQLALCHEMY_DATABASE_URL = f'mysql+pymysql://{mysql_config_dict.get("user")}:{mysql_config_dict.get("password")}@{mysql_config_dict.get("host")}:{mysql_config_dict.get("port")}/components?charset=utf8mb4&autocommit=true'
